...
urlpatterns = [
    ...
    path(
        "dashboard/employer/job/<int:id>/applicants/",
        views.all_applicants_view,
        name="applicants",
    ),
    path(
        "dashboard/employer/applicant/<int:id>/",
        views.applicant_details_view,
        name="applicant-details",
    ),
    path(
        "dashboard/employer/close/<int:id>/",
        views.make_complete_job_view,
        name="complete",
    ),
    path(
        "dashboard/jobseeker/delete-bookmark/<int:id>/",
